...
<!--제목 끝  -->	
	<div id="zentai">
	    ...
	    <div class="float-start">
   			 <input  class="form-control" type="text" id="shValue" value="<c:out value="${vo.shValue }"/>" name="shValue" placeholder="검색어를 입력해주세요." aria-label="default input example" style="margin-left:5px; width:300px;">
		</div>
		<div class="float-start">
		...
		<table class="table table-hover">
		    ...
		    <tbody>
		        ...
		        <c:forEach items="${list}" var="list" varStatus="status">
		            ...
		            <td><c:out value="${list.cc_ModDate}"/></td>
		        </tr>
		        </c:forEach>
		        </c:otherwise>
	        	</c:choose>
