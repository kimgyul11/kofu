...
<body> 
	                            	...
	                            	<c:forEach items="${list }" var="list" varStatus="status">
		                                    ...
		                                    <div class="d-flex bd-highlight">
		                                        ...
		                                        <div class="chat_product_info">
		                                            ...
		                                            <span class="status"><c:out value="${list.user_id }"/></span>
					                                 			<p>TEST TEXT FIELD</p>
		                                        </div>
		                                    </div>
		                                </li>
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyDA06daKscjAlDhSg3fY_S2NOrgKIioKDU",
    authDomain: "airlanguage-chat.firebaseapp.com",
    databaseURL: "https://airlanguage-chat-default-rtdb.firebaseio.com",
    projectId: "airlanguage-chat",
    storageBucket: "airlanguage-chat.appspot.com",
    messagingSenderId: "708777100852",
    appId: "1:708777100852:web:1815f90d87cdb58c1eac61"
  };
